...
PLUGIN_NAME="${TRMNL_SONOS_PLUGIN_NAME:-Sonos Local}"
SIDECAR_IMAGE_PATH="${TRMNL_SONOS_SIDECAR_IMAGE_PATH:-/home/dave/trmnl-display-scripts/tmp/sidecar_sonos_local_next.png}"
SIDECAR_IMAGE_NAME="${TRMNL_SONOS_SIDECAR_IMAGE_NAME:-sidecar_sonos_local_next}"
...
$metadata   = json_encode([
    ...
    'palette_id' => 10,
    'mime_type'  => 'image/png',
    'renderer'   => 'trmnl-display sonos colour sidecar',
]);
