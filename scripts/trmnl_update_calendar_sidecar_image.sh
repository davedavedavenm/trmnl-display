...
PLUGIN_NAME="${TRMNL_CALENDAR_PLUGIN_NAME:-Calendar Day View}"
SIDECAR_IMAGE_PATH="${TRMNL_CALENDAR_SIDECAR_IMAGE_PATH:-/home/dave/sidecar_calendar_day_next.png}"
SIDECAR_IMAGE_NAME="${TRMNL_CALENDAR_SIDECAR_IMAGE_NAME:-sidecar_calendar_day_next}"
SIDECAR_CONTAINER_IMAGE_PATH="${TRMNL_CALENDAR_SIDECAR_CONTAINER_IMAGE_PATH:-/var/www/html/storage/app/public/images/generated/${SIDECAR_IMAGE_NAME}.png}"
...
$metadata = json_encode([
    ...
    'palette_id' => 10,
    'mime_type' => 'image/png',
    'renderer' => 'trmnl-display calendar dayview colour sidecar',
]);
